...
class Detector:
    ...
    def createBoudingBox(self, image, threshold):
    ...
    def predictImage(self, imagePath, threshold=0.5):
        ...
        bboxImage = self.createBoudingBox(image, threshold)

        cv2.imwrite("results/" + self.modelName + ".jpg", bboxImage)
    ...
    def predictVideo(self, videoPath, threshold = 0.5):
        ...
        while success:
            ...
            cv2.putText(bboxImage, "FPS:" + str(int(fps)), (20,20), cv2.FONT_HERSHEY_PLAIN, 2, (0,255,0), 2)
            cv2.imshow("Result", bboxImage)
